  ...
  <div class="game container">
    ...
    <div class="game_start row">
      ...
      <div class="game_start_text col-12 col-xl-6">
        ...
        <button type="button" class="btn-l-icon-btn btn-r-icon-btn"><i class="fa-solid fa-gamepad"></i>開始遊戲<i
            class="fa-solid fa-arrow-up-right-from-square"></i></button>
      </div>
    </div>
    <div class="game_q">
      <div class="game_q_area">
        <div class="q_bar col-12 col-xl-6">
          <div class="q_bar_circle"><img src="/src/assets/images/game/game2.png" alt=""></div>
          <div class="q_bar_circle"><img src="/src/assets/images/game/game2.png" alt=""></div>
          <div class="q_bar_circle"></div>
          <div class="q_bar_circle"></div>
          <div class="q_bar_circle"></div>
